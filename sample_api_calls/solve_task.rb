...
# data_hash = {"source_code" => "print \"Hello world!\"", "lang" => "python"}
data_hash = {"source_code" => "puts \"Hello world!\"", "lang" => "ruby"}

args = {"email" => 'dimitrov.anton@gmail.com', "run[task_id]" => 1, "run[code]" => "run_task", "run[data]" => data_hash.to_json, "run[max_memory_kb]" => 10000000, "run[max_time_ms]" => 1000}
