...
if len(sys.argv) != 9:
  print >> sys.stderr, "Usage: <python path> <user for sandbox> <max cpu time> <max real time> <max memory> <stdin file> <source file> <output file>"
...
result = jail_code.jail_code('python', source_code, None, None, stdin_contents, "codemarathon")
